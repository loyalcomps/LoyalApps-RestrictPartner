...
class ResUsers(models.Model):
    ...
    can_add_partner = fields.Boolean('Can Add Partner')
...
class ProductProduct(models.Model):
    ...
    def create(self, vals):
        if not self.env.user.can_add_partner:
            raise UserError("You are not authorized to create new partner. Please contact the administrator")
